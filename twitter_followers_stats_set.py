...
if __name__ == '__main__':
    ...
    followers_file = "Twitter_Profiles/{}/followers.jsonl".format(screen_name)
    friends_file = "Twitter_Profiles/{}/friends.jsonl".format(screen_name)
    with open(followers_file) as f1, open(friends_file) as f2:
        ...
        print("{} is following {} friends".format(screen_name, len(friends)))
        print("{} has {} mutal followers".format(screen_name, len(mutual_friends)))
        print("{} friends are not following {} back".format(len(friends_not_following), screen_name))
        print("{} is not following {} of his followers".format(screen_name, len(followers_not_following)))"""
